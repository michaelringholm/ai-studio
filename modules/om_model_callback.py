...
class OMModelCallback(keras.callbacks.Callback):
    ...
    def on_train_begin(self, logs=None):
        ...
        #oml.debug(f"on_train_begin. Keys={keys}. Values={values}")

    def on_train_end(self, logs=None):
        keys = list(logs.keys())
        values=list(logs.values())
        #print("Stop training; got log keys: {}".format(keys))
        #oml.debug(f"on_train_end. Keys={keys}. Values={values}")
        self.observer.observe(self.observer.TRAINING_JOB_END_EVENT, args=(logs,))
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        self.observer.observe(self.observer.EPOCH_END_EVENT, args=(epoch,logs))
